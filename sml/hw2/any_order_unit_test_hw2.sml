...
use "to_string_hw2.sml";

val _ = let
	val _ = print "\n\n\n>>> begin test error output\n"

	val assertEquals_FullNameList = UnitTest.assertEquals full_name_list_to_string
	val assertEquals_Color = UnitTest.assertEquals color_to_string
	val assertEquals_CardList = UnitTest.assertEquals card_list_to_string
	val assertEquals_MoveList = UnitTest.assertEquals move_list_to_string
	...
	val _ = UnitTest.assertEqualsAnyOrder_StringList([], get_substitutions2 ([["foo"],["there"]], "foo"))
	val _ = UnitTest.assertEqualsAnyOrder_StringList(["Fredrick","Freddie","F"], get_substitutions2 ([["Fred","Fredrick"],["Elizabeth","Betty"],["Freddie","Fred","F"]], "Fred"))
	val _ = UnitTest.assertEqualsAnyOrder_StringList(["Jeffrey","Geoff","Jeffrey"], get_substitutions2 ([["Fred","Fredrick"],["Jeff","Jeffrey"],["Geoff","Jeff","Jeffrey"]], "Jeff"))
	val _ = UnitTest.leave()
	...
	val _ = UnitTest.enter("officiate")
	val _ = UnitTest.assertEquals_Int(6, officiate([(Hearts, Num 2),(Clubs, Num 4)],[Draw], 15))
	val _ = UnitTest.assertEquals_Int(3, officiate([(Clubs,Ace),(Spades,Ace),(Clubs,Ace),(Spades,Ace)], [Draw,Draw,Draw,Draw,Draw], 42))
	val _ = UnitTest.leave()

	val _ = UnitTest.enter("score_challenge")
	val _ = UnitTest.assertEquals_Int(4, score_challenge([(Hearts, Num 2),(Clubs, Num 4)],10))
	val _ = UnitTest.leave()

	val _ = UnitTest.enter("officiate_challenge")
	val _ = UnitTest.assertEquals_Int(6, officiate_challenge([(Hearts, Num 2),(Clubs, Num 4)],[Draw], 15))
	val _ = UnitTest.assertEquals_Int(3, officiate_challenge([(Clubs,Ace),(Spades,Ace),(Clubs,Ace),(Spades,Ace)], [Draw,Draw,Draw,Draw,Draw], 42))
	val _ = UnitTest.leave()

	val _ = UnitTest.enter("careful_player")
	val _ = assertEquals_MoveList([], careful_player([], 0))
	val _ = UnitTest.leave()
